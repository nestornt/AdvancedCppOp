...
{
    firstName = s.GetFirstName();  // to access the private member
...
int main()
{
    ...
    Employee e2 = e1; // A copy constructor is created by default if we dont specify it in Employee class
    e1.Print();       // Converted employer from a student
    e2.Print();       // Copy of the converted employer
